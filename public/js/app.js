...
(function () {
  ...
  function render(d) {
    ...
    if (p.instagram) cl.push(`<li><a ${linkAttrs(p.instagram)}>${ICONS.link}<span>Instagram</span></a></li>`);
    if (p.facebook) cl.push(`<li><a ${linkAttrs(p.facebook)}>${ICONS.link}<span>Facebook</span></a></li>`);
